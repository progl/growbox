...
float readTemp1(bool printRaw = false)
{
    ...
    return ((float)value - CALPOINT1_RAW[0]) * (CALPOINT2_CELSIUS[0] - CALPOINT1_CELSIUS[0]) /
               (CALPOINT2_RAW[0] - CALPOINT1_RAW[0]) +
           CALPOINT1_CELSIUS[0];
}
...
float readTemp2(bool printRaw = false)
{
    ...
    return ((float)value * 10.0 - CALPOINT1_RAW[1]) * (CALPOINT2_CELSIUS[1] - CALPOINT1_CELSIUS[1]) /
               (CALPOINT2_RAW[1] - CALPOINT1_RAW[1]) +
           CALPOINT1_CELSIUS[1];
}
