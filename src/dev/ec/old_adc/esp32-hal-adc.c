...
void __wega_analogSetAttenuation(adc_attenuation_t attenuation)
{
...
extern uint16_t wega_analogRead(uint8_t pin) __attribute__ ((weak, alias("__wega_analogRead")));
extern void wega_analogReadResolution(uint8_t bits) __attribute__ ((weak, alias("__wega_analogReadResolution")));
extern void wega_analogSetWidth(uint8_t bits) __attribute__ ((weak, alias("__wega_analogSetWidth")));
extern void wega_analogSetCycles(uint8_t cycles) __attribute__ ((weak, alias("__wega_analogSetCycles")));
extern void wega_analogSetSamples(uint8_t samples) __attribute__ ((weak, alias("__wega_analogSetSamples")));
extern void wega_analogSetClockDiv(uint8_t clockDiv) __attribute__ ((weak, alias("__wega_analogSetClockDiv")));
extern void wega_analogSetAttenuation(adc_attenuation_t attenuation) __attribute__ ((weak, alias("__wega_analogSetAttenuation")));
extern void wega_analogSetPinAttenuation(uint8_t pin, adc_attenuation_t attenuation) __attribute__ ((weak, alias("__wega_analogSetPinAttenuation")));
extern int wega_hallRead() __attribute__ ((weak, alias("__wega_hallRead")));

extern bool wega_adcAttachPin(uint8_t pin) __attribute__ ((weak, alias("__wega_adcAttachPin")));
extern bool wega_adcStart(uint8_t pin) __attribute__ ((weak, alias("__wega_adcStart")));
extern bool wega_adcBusy(uint8_t pin) __attribute__ ((weak, alias("__wega_adcBusy")));
extern uint16_t wega_adcEnd(uint8_t pin) __attribute__ ((weak, alias("__wega_adcEnd")));
