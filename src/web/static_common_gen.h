...
void setupRoutes(AsyncWebServer& server) {
  ...
  server.on("/assets/js/main-Cj2XZQ2o.js", HTTP_GET, [](AsyncWebServerRequest* request) { serveFileWithGzip(request, "/assets/js/main-Cj2XZQ2o.js", "application/javascript", true); });
