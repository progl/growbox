...
void setupRoutes(AsyncWebServer& server) {
  ...
  server.on("/assets/js/main-DK2MhnQY.js", HTTP_GET, [](AsyncWebServerRequest* request) { serveFileWithGzip(request, "/assets/js/main-DK2MhnQY.js", "application/javascript", true); });
